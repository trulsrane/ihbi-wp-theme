...
<div class="wp-block-query alignwide">
    <!-- wp:post-template {"align":"full","className":"news-grid","layout":{"type":"grid","columnCount":3}} -->
        ...
        <div class="wp-block-group is-style-card">
            ...
            <!-- wp:post-title {"isLink":true,"fontSize":"heading-4","style":{"spacing":{"margin":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|20"}}}} /-->
            <!-- wp:post-excerpt {"moreText":"Read more","excerptLength":10,"fontSize":"ihbi-body"} /-->
            ...
            <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--30)">
                ...
                <!-- wp:post-date {"isLink":false,"fontSize":"ihbi-caption"} /-->
            </div>
            <!-- /wp:group -->
        </div>
        <!-- /wp:group -->
